...
<div class="container">
    ...
    <form action="{{ route('subcategory.store') }}" method="POST" class="row d-flex justify-content-around">
        @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="input-group">
                                ...
                                <select class="input-control is-medium" id="category_id" name="category_id">
