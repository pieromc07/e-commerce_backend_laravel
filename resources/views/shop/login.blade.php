                    ...
                    <div class=" main-content-area">
                        <div class="wrap-login-item ">
                            <div class="login-form form-item form-stl">
                                <form name="frm-login" action="{{ route('shop.login') }}" method="POST">
                                    @csrf
                                    ...
                                    <fieldset class="wrap-input">
                                        ...
                                        <a class="link-function left-position" href="{{route('shop.showRegister')}}"
                                            title="Forgotten password?">sign up here</a>
                                    </fieldset>
